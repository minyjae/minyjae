...
* This is all technical skill I learned in unemployed (CI/CD workflow, Jenkins, Data Cleaning, ML training, Angular, C#.Net ASP Web API, gRPC, Microservice, Basic Deploy using AWS "like container runing on EC2 and nginx to serve content", Cloudflare DNS)
